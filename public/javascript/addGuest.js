async function addGuestFormHandler(event) {
  ...
  const phone_number = document
    .querySelector("#phonenumber-addGuest")
    .value.trim();
  const rsvp = document.querySelector("#rsvp-addGuest:checked").value.trim();
  const food_id = document.querySelector("#foodchoice-addGuest").value.trim();
